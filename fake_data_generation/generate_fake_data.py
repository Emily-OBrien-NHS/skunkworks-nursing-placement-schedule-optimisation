...
class FakeData():
    ...
    student_df["is_driver"] = random.choices([True, False], [0.75, 0.25], args.number_of_students)
    ...
    ward_df["need_to_drive"] = random.choices([True, False], [0.75, 0.25], args.number_of_students)
    ward_df["DYAD"] = random.choices([True, False], [0.75, 0.25], args.number_of_students)
    ...
    fake_data_download = fake_data_excel_file(student_df, ward_df, placement_df)
    fake_data_download_link = Schedule.create_download_link(fake_data_download)
